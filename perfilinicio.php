  ...
  <div class="flex h-screen">
   ...
   <div class="flex-1">
    <div class="bg-blue-800 text-white p-4">
     <h1 class="text-xl font-semibold" onclick=(cambiarParametrom("p"))>
      Perfil
     </h1>
    </div>
    <div class="p-8">
     <div class="bg-white rounded-lg shadow-lg p-6">
      ...
      <div class="border-b border-gray-300 mb-6">
       <nav class="flex space-x-6">
        <a class="text-blue-800 border-b-2 border-blue-800 pb-1" onclick=(cambiarParametroN("p"))>
         Perfil
        </a>
        <a class="text-gray-700 hover:text-blue-800" onclick=(cambiarParametroN("c"))>
         Contraseña
        </a>
       </nav>
      </div>
      <form>
       <div class="space-y-4">
        <div>
         <label class="block text-gray-700" for="old-password">
          Full name: ' . $dtosaaa['nombre'] . '
         </label>
         
        </div>
        <div>
         <label class="block text-gray-700" for="new-password">
          User: ' . $dtosaaa['usuario'] . '
         </label>
